...
<body>
    ...
    <?php if (session()->has('error')): ?>
        <div style="color: #d32f2f; padding: 15px; background: #ffebee; border: 2px solid #d32f2f; border-radius: 5px; margin: 15px 0;">
            <strong>❌ Erreur :</strong> <?= session()->getFlashdata('error') ?>
        </div>
    <?php endif; ?>

    <?php if (session()->has('success')): ?>
        <div style="color: #388e3c; padding: 15px; background: #e8f5e9; border: 2px solid #388e3c; border-radius: 5px; margin: 15px 0;">
